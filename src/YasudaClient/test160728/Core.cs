...
namespace Core
{
    ...
    public class Twitter
    {
        ...
        /// </summary>
        private static Keys MyTokens => _myTokens ?? (_myTokens = new Keys { AccessSecret = test160728.MyKeys.AccessSecret, AccessToken = test160728.MyKeys.AccessToken, ConsumerKey = test160728.MyKeys.ConsumerKey, ConsumerSecret = test160728.MyKeys.ConsumerSecret });
